...
<body>
  <div class="box">
   <table  style ="border-color:red; font-size:16pt"  align="center" width="100%" height="100%">
      <tr>
        <td style="color:white"><h1 align="center"><marquee>Welcome To online Library System</marquee></h1></td>
      </tr>
      <tr>
...
<ul>
  ...
  <li><a href = "edit_book.php"  style="background-color: #E05D1E">Edit Book</a></li>
...
<div class = "header">
  ...
  <table style= "color:#FFFFFF;padding-top:10px;">
       ...
       <tr>
     <td>BOOK ID:</td>
     <td><input type="text" name="book_id" placeholder="books ID" required=""/></td>
	</tr>
	...
	<tr>
	  <td>NO OF COPIES:</td>
	 <td><input type="text" name="copies" placeholder="Available copies" required=""/></td>
	</tr>
