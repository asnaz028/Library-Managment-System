...
<ul>
  ...
  <li><a href = "edit_book.php" >Edit Book</a></li>
    <li><a href = "delbook.php"  style="background-color:#E05D1E">Delete Book</a></li>
...
<div class = "header">
  ...
  <table style= "color:#FFFFFF;padding-top:10px;">
     ...
     <td><input style="width:200px;" type="text" name="book_id" placeholder="books ID" required=""/></td>
	</tr>
